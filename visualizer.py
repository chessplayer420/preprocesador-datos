...
class DataVisualizer:
    """
    Clase encargada de generar todas las representaciones gráficas utilizando
    las librerías matplotlib y seaborn.
    """
    ...
    def mostrar_dispersion(df_original, df_procesado, col_x, col_y):
        """
        Crea dos gráficos de dispersión (scatter plots) lado a lado para 
        comparar los datos crudos vs los datos tras la normalización.
        """
    ...
    def mostrar_heatmap(df, columnas):
        """Genera un mapa de calor mostrando la correlación de Pearson entre las variables."""
